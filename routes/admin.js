...
routes.get("/category",auth.admin_auth,auth.getCsrfToken,categoryControllers.category);

// GET : /admin/category/delete -> to delete particular category 
routes.delete("/category/:id/delete",auth.admin_auth,categoryControllers.delete);
